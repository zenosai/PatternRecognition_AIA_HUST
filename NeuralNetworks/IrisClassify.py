...
from Model import MulNet, show_result, train
...
if __name__ == '__main__':
    ...
    # nn
    model = MulNet(4, 3, dim_h=11, num_blocks=1, act='sigmoid')
    optimizer = optim.SGD(model.parameters(), lr=1, momentum=0.5, nesterov=True)
    ...
    acc_history, acc_test_history, loss_history, iter_history = train(model, loader_train, loader_test, optimizer, epoch=1000)
